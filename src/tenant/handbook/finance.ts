      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Up-to-date directory of all cells and PCUs thereof" },
            ...
            { text: "Minutes of all Executive Meetings held" },
            { text: "File containing all bank allocation advices" },
            { text: "Cheque book stubs" },
            { text: "File for correspondences" },
